...
System.register('src/blocks-config', ['npm:babel-runtime@5.2.9/helpers/create-class', 'npm:babel-runtime@5.2.9/helpers/class-call-check', 'npm:babel-runtime@5.2.9/core-js/map', 'github:components/jquery@2.1.3'], function (_export) {
  var _createClass, _classCallCheck, _Map, $, BlocksConfig;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('default', new BlocksConfig());
    }
  };
});
System.register('src/blocks-page-viewer', ['npm:babel-runtime@5.2.9/helpers/create-class', 'npm:babel-runtime@5.2.9/helpers/class-call-check', 'src/blocks-config'], function (_export) {
	...
	return {
		...
		execute: function () {
			...
			_export('default', new BlocksPageViewer());
		}
	};
});
