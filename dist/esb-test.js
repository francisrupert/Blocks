...
System.register('src/blocks-config', ['npm:babel-runtime@5.2.9/helpers/create-class', 'npm:babel-runtime@5.2.9/helpers/class-call-check', 'npm:babel-runtime@5.2.9/core-js/symbol', 'npm:babel-runtime@5.2.9/core-js/map', 'github:components/jquery@2.1.3'], function (_export) {
  var _createClass, _classCallCheck, _Symbol, _Map, $, singleton, singletonEnforcer, BlocksConfig;
  ...
  return {
    ...
    execute: function () {
      ...
      singleton = _Symbol();
      singletonEnforcer = _Symbol();

      BlocksConfig = (function () {
        function BlocksConfig(enforcer) {
          _classCallCheck(this, BlocksConfig);
        ...
        _createClass(BlocksConfig, [{
          ...
          get: function () {
            if (!this[singleton]) {
              this[singleton] = new BlocksConfig(singletonEnforcer);
            }
