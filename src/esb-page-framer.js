...
export class EsbPageFramer {
	...
	create_placeholder_element() {
		...
		if (self.options.href) { 
			self.placeholder_element += '<a class="esb-page-framer-link esb-page-framer-inner-wrap" href="' + self.options.href + '">'; 
		}
		else {
			self.placeholder_element += '<span class="esb-page-framer-inner-wrap">'; 
		}
